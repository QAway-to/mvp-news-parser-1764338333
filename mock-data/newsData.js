// Project: Парсер сайта elibrary

На сайте выложены научные журналы. Нужно спарсивать конкретные журналы, все выпуски, в виде PDF. Сайт требует логиниться. Лучше будет, если парсер будет работать на внешнем серв...
